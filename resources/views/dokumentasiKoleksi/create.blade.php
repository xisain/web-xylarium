            ...
            <div class="row">
                ...
                <div class="form-control col-sm m-2">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="file" name="foto_trapesium" id="foto_trapesium" class="form-control" accept="image/*" onchange="previewImage('foto_trapesium', 'trapesium_preview')">
                        <img id="trapesium_preview" src="" alt="" class="img-fluid mt-2" style="max-height: 200px;">
                    </div>
                    <div class="form-group mb-3">
                        <label for="foto_pola">Pola</label>
                        <input type="file" name="foto_pola" id="foto_pola" class="form-control" accept="image/*" onchange="previewImage('foto_pola', 'pola_preview')">
